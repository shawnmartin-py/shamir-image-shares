...
static void createModuleCodeObjects(void) {
    ...
    codeobj_ff6280f515667f0fe57e98366d422b3d = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[15], mod_consts[15], NULL, NULL, 0, 0, 0);
    codeobj_3c7d5c1d5f8c5ff7eb2e0a8dc844e7ab = MAKE_CODE_OBJECT(module_filename_obj, 41, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[1], mod_consts[1], NULL, NULL, 0, 0, 0);
    codeobj_e55b1f318943d2d25651474c340aacad = MAKE_CODE_OBJECT(module_filename_obj, 45, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[2], mod_consts[2], NULL, NULL, 0, 0, 0);
}
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__1_have_aes_ni(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_3c7d5c1d5f8c5ff7eb2e0a8dc844e7ab = MAKE_FUNCTION_FRAME(tstate, codeobj_3c7d5c1d5f8c5ff7eb2e0a8dc844e7ab, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_3c7d5c1d5f8c5ff7eb2e0a8dc844e7ab);
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__2_have_clmul(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_e55b1f318943d2d25651474c340aacad)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_e55b1f318943d2d25651474c340aacad = MAKE_FUNCTION_FRAME(tstate, codeobj_e55b1f318943d2d25651474c340aacad, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_e55b1f318943d2d25651474c340aacad);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_ff6280f515667f0fe57e98366d422b3d);
